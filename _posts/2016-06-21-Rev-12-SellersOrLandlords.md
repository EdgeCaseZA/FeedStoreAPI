---
layout: post
title:  "Updated to Rev 12 - SellersAndLandlords"
...
_Please note that in cases where the listingType=Sale, then the SellerOrLandlord data will assume Seller, and in cases where listingType=Rent, then it will assume Landlord._
