...
- The `listingType` denotes whether this listing is a property For Sale, or a property To Rent.  The state of this attribute will determine the structure of the remaining parts of the XML response.
- The legal set of values for `propertyType` depends on the value of the `listingZone`, as defined by the following table:
